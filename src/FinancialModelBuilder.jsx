...
<a href="/learn" target="_blank" rel="noopener noreferrer" className="ff-body text-[12px] ml-1 inline-flex items-center gap-1" style={{color:C.muted,textDecoration:'none'}}><FileText size={12}/> Full guide</a>
</div>
