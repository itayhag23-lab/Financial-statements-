...
export async function signInWithGoogle() {
  ...
  // Flag the pending OAuth so we can route to the right place once the session
  // resolves — even if Supabase's Site URL config lands us on the homepage.
  // Don't clobber a destination an auth gate already stashed (e.g. "sign in
  // to use AI" from inside a project) — only default to the dashboard.
  try {
    if (!sessionStorage.getItem('koala:postAuthRedirect')) {
